...
DROP VIEW kaf.v_cbte_deprec_actualiz_activo_cab;
CREATE OR REPLACE VIEW kaf.v_cbte_deprec_actualiz_activo_cab (
    id_movimiento,
    id_depto_af,
    fecha_mov,
...
DROP VIEW kaf.v_cbte_deprec_actualiz_dep_acum_cab;
CREATE OR REPLACE VIEW kaf.v_cbte_deprec_actualiz_dep_acum_cab (
    id_movimiento,
    id_depto_af,
    fecha_mov,
...
DROP VIEW kaf.v_cbte_deprec_actualiz_dep_per_cab;
CREATE OR REPLACE VIEW kaf.v_cbte_deprec_actualiz_dep_per_cab (
    id_movimiento,
    id_depto_af,
    fecha_mov,
...
DROP VIEW kaf.v_cbte_deprec_actualiz_dep_per_detalle;	
CREATE OR REPLACE VIEW kaf.v_cbte_deprec_actualiz_dep_per_detalle (
    id_clasificacion,
    codigo_completo_tmp,
    nombre,
...
DROP VIEW kaf.v_cbte_baja_valor_neto;
CREATE OR REPLACE VIEW kaf.v_cbte_baja_valor_neto (
    id_movimiento,
    id_centro_costo,
    id_clasificacion,
