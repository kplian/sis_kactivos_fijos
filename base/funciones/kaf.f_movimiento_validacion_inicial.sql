CREATE OR REPLACE FUNCTION "kaf"."f_movimiento_validacion_inicial"(p_id_usuario int4, p_id_proceso_wf int4, p_id_estado_anterior int4, p_id_tipo_estado_actual int4)
