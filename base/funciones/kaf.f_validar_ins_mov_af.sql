...
***************************************************************************
 ...
 #13    KAF       ETR           05/06/2019  RCM         Se aumenta estado 'anulado' para no considerar igual que los 'finalizado'
...
BEGIN
    ...
    for v_registros_mov in (
            ...
            and mov.estado  not in ('finalizado','anulado')) LOOP --#13: se aumenta estado 'anulado'
