CREATE OR REPLACE FUNCTION kaf.f_lista_funcionario_resp_depto_sel (
...
***************************************************************************
 SCRIPT:        kaf.f_lista_funcionario_resp_depto_sel
 DESCRIPCIÓN:   Lista al funcionario responsable del Depto de Activos Fijos
 AUTOR:         RCM
 FECHA:         04/10/2017
 COMENTARIOS:   
***************************************************************************
...
BEGIN
    ...
    v_nombre_funcion ='kaf.f_lista_funcionario_resp_depto_sel';

    --Recuperación del funcionario responsable del Depto.
    select
