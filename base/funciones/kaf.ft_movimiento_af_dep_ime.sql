			...
			*/
			...
			FROM (
			  ...
			  JOIN kaf.tmovimiento_af_dep mdep ON mdep.id_activo_fijo_valor = afv.id_activo_fijo_valor 
			    ...
			    AND date_trunc('month', mdep.fecha) = '01-06-2021'
			  WHERE rd.fecha = '01-06-2021'
			  AND rd.codigo IN (
			  '04.16.7.2209-0',
			  '04.16.7.2235-0',
			  '04.16.7.3251-0',
