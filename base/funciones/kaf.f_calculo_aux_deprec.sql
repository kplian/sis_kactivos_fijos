...
/**************************************************************************
 ...
 DESCRIPCION:   Calcula la depreciación con actualización de un monto, y da como respuesta el total de la depreciación acumulada y el incremento del activo
 AUTOR:         RCM
 FECHA:         28/09/2018
 COMENTARIOS:
***************************************************************************
 ISSUE  SIS     EMPRESA  FECHA        AUTOR       DESCRIPCION
        PRO     ETR      09/09/2019   RCM         Creación del archivo
***************************************************************************/
...
BEGIN
    ...
    FOR i IN 1..v_meses + 1 LOOP
        ...
        --v_fecha_inf, v_fecha_sup,v_tc_ini, v_tc_fin, v_factor, round(v_importe,2), round(v_deprec,2), v_vida_util, round(v_deprec_acum,2), round(v_inc_dep,2), round(v_inc_val,2);
