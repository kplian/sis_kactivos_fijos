CREATE OR REPLACE FUNCTION kaf.f_lista_funcionario_transf_orig_sel (
...
***************************************************************************
 SCRIPT:        kaf.f_lista_funcionario_transf_orig_sel
 DESCRIPCIÓN:   Lista al funcionario origen de la transferencia
 AUTOR:         RCM
 FECHA:         04/10/2017
 COMENTARIOS:   
***************************************************************************
...
BEGIN
    ...
    v_nombre_funcion ='kaf.f_lista_funcionario_transf_orig_sel';

    --Recuperación del funcionario original de la transferencia
    select
    id_funcionario
    into
    v_id_funcionario
