	...
	Atributos:[
		...
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'movesp.estado_reg',type:'string'},
				id_grupo:1,
				grid:true,
				form:false
		},
		...
		},
		{
			config:{
				...
				type:'NumberField',
				filters:{pfiltro:'movesp.importe',type:'numeric'},
				id_grupo:1,
				grid:true,
				form:true
		},
		...
		},
		{
			config:{
				...
				type:'DateField',
				filters:{pfiltro:'movesp.fecha_reg',type:'date'},
				id_grupo:1,
				grid:true,
				form:false
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'movesp.usuario_ai',type:'string'},
				id_grupo:1,
				grid:true,
				form:false
		},
		...
		},
		{
			config:{
				...
				type:'Field',
				filters:{pfiltro:'movesp.id_usuario_ai',type:'numeric'},
				id_grupo:1,
				grid:false,
				form:false
		},
		...
		},
		{
			config:{
				...
				type:'DateField',
				filters:{pfiltro:'movesp.fecha_mod',type:'date'},
				id_grupo:1,
				grid:true,
				form:false
		}
