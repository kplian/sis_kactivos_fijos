...
***************************************************************************
 ...
 #19    KAF       ETR           13/08/2019  RCM         Reporte Impuesto Vehículos
***************************************************************************
*/
header("content-type: text/javascript; charset=UTF-8");
?>
<script>
Phx.vista.ParametrosRepImpuestosVehiculos = {
	require: '../../../sis_kactivos_fijos/vista/reportes/ParametrosBase.php',
	requireclase: 'Phx.vista.ParametrosBase',

	constructor: function(config){
		Phx.vista.ParametrosRepImpuestosVehiculos.superclass.constructor.call(this,config);
	...
	definicionRutareporte: function(report){
		this.rutaReporte = '../../../sis_kactivos_fijos/vista/reportes/ReporteImpuestosVehiculos.php';
		this.claseReporte = 'ReporteImpuestosVehiculos';
		this.titleReporte = 'Impuestos Vehículos';
	},
