...
***************************************************************************
 ...
 #26    KAF       ETR           16/08/2019  RCM         Reporte Altas por Origen
***************************************************************************
*/
header("content-type: text/javascript; charset=UTF-8");
?>
<script>
Phx.vista.ParametrosRepAltaOrigen = {
	require: '../../../sis_kactivos_fijos/vista/reportes/ParametrosBase.php',
	requireclase: 'Phx.vista.ParametrosBase',

	constructor: function(config){
		Phx.vista.ParametrosRepAltaOrigen.superclass.constructor.call(this,config);
	...
	definicionRutareporte: function(report){
		this.rutaReporte = '../../../sis_kactivos_fijos/vista/reportes/ReporteAltaOrigen.php';
		this.claseReporte = 'ReporteAltaOrigen';
		this.titleReporte = 'Origen Altas';
	},
	...
	definirParametros: function(report){
		...
		this.configElement(this.cmbTipoActivacion, true, true);
		this.configElement(this.txtNrotramite, true, true);
